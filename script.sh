 dirrectory_to_backup="/c/Users/akilb/Directorytobackup" # this is the directory we to zip and carete a backup 

 backup_location="/c/Users/akilb/Directorytobackup" # this is the path where to store the backup
